...
const LogoIcon = () => (
  <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
    ...
    <circle cx="18" cy="18" r="4" fill="white" fillOpacity="0.2"/>
  </svg>
);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm w-full max-w-sm p-8">
        ...
        {/* Error */}
        {error && (
          <div className="mb-4 flex items-center gap-2 text-sm text-red-600 bg-red-50 border border-red-100 px-3 py-2.5 rounded-xl">
